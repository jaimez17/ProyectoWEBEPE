...
ActiveRecord::Schema.define(version: 20150219055501) do
  ...
  add_index "comentarios", ["empleado_id"], name: "index_comentarios_on_empleado_id"
  add_index "comentarios", ["ticket_id"], name: "index_comentarios_on_ticket_id"
